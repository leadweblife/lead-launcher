 ...
 */
public class ApplicationStackLayout extends ViewGroup implements View.OnClickListener {
    ...
    public ApplicationStackLayout(Context context) {
        super(context);
        initLayout();
    }

    public ApplicationStackLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
